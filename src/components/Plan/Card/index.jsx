...
const Card = props => (
  <div className="card-plan">
    ...
    <p className="card-plan__cities">
      ...
      Metropolitano, Centro, Chácara Santo Antônio, Continental, Santana, Santo
      André, São Caetano, Tamboré e West Plaza.
    </p>
    <div className="card-plan__price">R$ {props.price} / mês</div>
    {props.plan.gif ? (
      <img className="gif" alt="Gif" src={props.plan.gif} />
    ) : null}
  </div>
);
