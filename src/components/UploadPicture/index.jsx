  ...
  render() {
    return (
      <div className="upload-picture">
        { this.props.picture.src ? <img src={this.props.picture.src} className="picture" alt="Your face here" /> : <FontAwesomeIcon icon={faUser} /> }
...
const mapDispatchToProps = dispatch => bindActionCreators({ setPicture }, dispatch);
